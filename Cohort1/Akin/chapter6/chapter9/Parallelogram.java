...
public class Parallelogram extends Quadrilateral {
	...
	Parallelogram(Point first,Point second,Point third,Point fourth,int height) {
	...
	@Override
	public double area() {
		double part = getDistanceBC() * getHeight();
		return part;
	...
	public String toString() {
		return String.format("%s %.2f%n", "Area of a Parallelogram: ", area());
	}
