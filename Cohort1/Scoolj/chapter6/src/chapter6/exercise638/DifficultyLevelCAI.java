 ...
 *
 */
public class DifficultyLevelCAI {
	...
	int randomDigit1 = 1 + randomNumber.nextInt(9);
	int  randomDigit2= 1 + randomNumber.nextInt(9);
	...
	public static int calculateProductHight() {
	int randomDigit1 = 10 + randomNumber.nextInt(24);
	int  randomDigit2= 10 + randomNumber.nextInt(24);
	...
	public static int findMultiplication() {
		...
		for (counter= 1; counter <=10; counter++) {
			...
			if (counter >= 5) {
				System.out.println("Note: This is difficult level!" );
				findProduct = calculateProductHight();
			}
			else {
				findProduct = calculateProduct();
			}
