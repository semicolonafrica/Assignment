/* Author: ADEBAYO Johnson
 Date: 29/06/2019 
 Location of exercise:  Exercise 6, Question 6.38
 Purpose: For Computer Assisted Instruction (CAI) with difficulty levels
*/
...
public class CIADifficultLevels {
	...
	public static void generateNumbers() {
		number1 = 1 + random.nextInt(9);
		number2 = 1 + random.nextInt(9);	
	}
	public static void generateNumbers2() {
		number1 = 1 + random.nextInt(1000);
		number2 = 1 + random.nextInt(1000);	
	}
